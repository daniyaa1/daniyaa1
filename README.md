...
- 🎓 3rd year CSE student figuring things out one project at a time
- 💻 Into full-stack dev, AI/ML, and open source
- 🤝 Open to collabs and cool ideas
...
|---|---------|-------------|
| 🌾 | [Kisan Setu](https://github.com/daniyaa1/Kisan_Setu_SIH_2025) | AI farming assistant — multilingual voice, pest detection, soil analysis |
| 🤟 | [Ava](https://github.com/daniyaa1/Ava_ML_Version) | Real-time ISL ↔ text/speech translation pipeline |
| 🔍 | [YOLO Inlay Hints](https://github.com/daniyaa1/yolo-inlay-hints) | VS Code extension that labels YOLO annotation class IDs |
| 🤖 | [AI Plagiarism Checker](https://github.com/daniyaa1/AI-Plagiarism-Checker) | Flags AI-generated text using perplexity & burstiness |
